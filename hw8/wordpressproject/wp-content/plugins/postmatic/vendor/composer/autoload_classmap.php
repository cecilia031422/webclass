...
return array(
    ...
    'HTML_To_Markdown' => $vendorDir . '/vernal-creative/html-to-markdown/HTML_To_Markdown.php',
    ...
    'Prompt_Admin_Comment_Options_Tab' => $baseDir . '/admin/comment-options-tab.php',
    'Prompt_Admin_Conditional_Notice' => $baseDir . '/admin/conditional-notice.php',
    'Prompt_Admin_Core_Options_Tab' => $baseDir . '/admin/core-options-tab.php',
    'Prompt_Admin_Email_Options_Tab' => $baseDir . '/admin/email-options-tab.php',
    'Prompt_Admin_Feed' => $baseDir . '/admin/feed.php',
    'Prompt_Admin_Import_Options_Tab' => $baseDir . '/admin/import-options-tab.php',
    'Prompt_Admin_Local_Mail_Notice' => $baseDir . '/admin/local-mail-notice.php',
    'Prompt_Admin_Notice_Handling' => $baseDir . '/admin/notice-handling.php',
    'Prompt_Admin_Options_Page' => $baseDir . '/admin/options-page.php',
    'Prompt_Admin_Options_Tab' => $baseDir . '/admin/options-tab.php',
    'Prompt_Admin_Recommended_Plugins_Options_Tab' => $baseDir . '/admin/recommended-plugins-options-tab.php',
    'Prompt_Admin_Subscribe_Reloaded_Import' => $baseDir . '/admin/subscribe-reloaded-import.php',
    'Prompt_Admin_Subscribe_Reloaded_Import_Options_Tab' => $baseDir . '/admin/subscribe-reloaded-import-options-tab.php',
    'Prompt_Admin_Upgrade_Options_Tab' => $baseDir . '/admin/upgrade-options-tab.php',
    'Prompt_Admin_Users_Handling' => $baseDir . '/admin/users-handling.php',
    'Prompt_Agree_Matcher' => $baseDir . '/core/matchers/agree-matcher.php',
    'Prompt_Ajax_Handling' => $baseDir . '/core/ajax-handling.php',
    'Prompt_Api' => $baseDir . '/core/api.php',
    'Prompt_Api_Client' => $baseDir . '/core/api-client.php',
    'Prompt_Attachment_Image' => $baseDir . '/core/attachment-image.php',
    'Prompt_Command_Handling' => $baseDir . '/core/command-handling.php',
    'Prompt_Comment' => $baseDir . '/core/comment.php',
    'Prompt_Comment_Command' => $baseDir . '/core/commands/comment-command.php',
    'Prompt_Comment_Email_Batch' => $baseDir . '/core/email-batches/comment-email-batch.php',
    'Prompt_Comment_Flood_Command' => $baseDir . '/core/commands/comment-flood-command.php',
    'Prompt_Comment_Flood_Controller' => $baseDir . '/core/comment-flood-controller.php',
    'Prompt_Comment_Form_Handling' => $baseDir . '/core/comment-form-handling.php',
    'Prompt_Comment_IQ_Handling' => $baseDir . '/core/comment-iq-handling.php',
    'Prompt_Comment_IQ_Sync' => $baseDir . '/core/comment-iq-sync.php',
    'Prompt_Comment_Mailer' => $baseDir . '/core/mailers/comment-mailer.php',
    'Prompt_Comment_Mailing' => $baseDir . '/core/comment-mailing.php',
    'Prompt_Comment_Wp_Mailer' => $baseDir . '/core/mailers/comment-wp-mailer.php',
    'Prompt_Configuration_Handling' => $baseDir . '/core/configuration-handling.php',
    'Prompt_Configurator' => $baseDir . '/core/configurator.php',
    'Prompt_Confirmation_Command' => $baseDir . '/core/commands/confirmation-command.php',
    'Prompt_Content_Handling' => $baseDir . '/core/content-handling.php',
    'Prompt_Core' => $baseDir . '/core/core.php',
    'Prompt_Cron_Handling' => $baseDir . '/core/cron-handling.php',
    'Prompt_Email_Batch' => $baseDir . '/core/email-batches/email-batch.php',
    'Prompt_Email_Comment_Rendering' => $baseDir . '/core/email-comment-rendering.php',
    'Prompt_Enum_Connection_Status' => $baseDir . '/enums/connection-status.php',
    'Prompt_Enum_Content_Types' => $baseDir . '/enums/content-types.php',
    'Prompt_Enum_Email_Footer_Types' => $baseDir . '/enums/email-footer-types.php',
    'Prompt_Enum_Email_Header_Types' => $baseDir . '/enums/email-header-types.php',
    'Prompt_Enum_Email_Transports' => $baseDir . '/enums/email-transports.php',
    'Prompt_Enum_Error_Codes' => $baseDir . '/enums/error-codes.php',
    'Prompt_Enum_Message_Types' => $baseDir . '/enums/message-types.php',
    'Prompt_Enum_Urls' => $baseDir . '/enums/urls.php',
    'Prompt_Environment' => $baseDir . '/core/environment.php',
    'Prompt_Event_Handling' => $baseDir . '/core/event-handling.php',
    'Prompt_Factory' => $baseDir . '/core/factory.php',
    'Prompt_Formatting' => $baseDir . '/core/formatting.php',
    'Prompt_Freemius' => $baseDir . '/core/freemius.php',
    'Prompt_Grab_Icon' => $baseDir . '/core/grab-icon.php',
    'Prompt_Handlebars' => $baseDir . '/core/handlebars.php',
    'Prompt_Hasher' => $baseDir . '/core/hasher.php',
    'Prompt_Html_To_Markdown' => $baseDir . '/core/html-to-markdown.php',
    'Prompt_Inbound_Handling' => $baseDir . '/core/inbound-handling.php',
    'Prompt_Inbound_Messenger' => $baseDir . '/core/inbound-messenger.php',
    'Prompt_Instant_Matcher' => $baseDir . '/core/matchers/instant-matcher.php',
    'Prompt_Interface_Command' => $baseDir . '/interfaces/command.php',
    'Prompt_Interface_Http_Client' => $baseDir . '/interfaces/http-client.php',
    'Prompt_Interface_Identifiable' => $baseDir . '/interfaces/identifiable.php',
    'Prompt_Interface_License_Status' => $baseDir . '/interfaces/license-status.php',
    'Prompt_Interface_Reschedulable' => $baseDir . '/interfaces/reschedulable.php',
    'Prompt_Interface_Subscribable' => $baseDir . '/interfaces/subscribable.php',
    'Prompt_Key_Importer' => $baseDir . '/core/key-importer.php',
    'Prompt_Logging' => $baseDir . '/core/logging.php',
    'Prompt_Mailer' => $baseDir . '/core/mailers/mailer.php',
    'Prompt_Mailing' => $baseDir . '/core/mailing.php',
    'Prompt_Matcher' => $baseDir . '/core/matchers/matcher.php',
    'Prompt_Meta_Subscribable_Object' => $baseDir . '/core/meta-subscribable-object.php',
    'Prompt_New_Post_Comment_Command' => $baseDir . '/core/commands/new-post-comment-command.php',
    'Prompt_Option_Subscribable_Object' => $baseDir . '/core/option-subscribable-object.php',
    'Prompt_Options' => $baseDir . '/core/options.php',
    'Prompt_Outbound_Handling' => $baseDir . '/core/outbound-handling.php',
    'Prompt_Post' => $baseDir . '/core/post.php',
    'Prompt_Register_Subscribe_Command' => $baseDir . '/core/commands/register-subscribe-command.php',
    'Prompt_Rejoin_Matcher' => $baseDir . '/core/matchers/rejoin-matcher.php',
    'Prompt_Request_Signature' => $baseDir . '/core/request-signature.php',
    'Prompt_Rescheduler' => $baseDir . '/core/rescheduler.php',
    'Prompt_Rest_Api' => $baseDir . '/core/rest-api.php',
    'Prompt_Routing' => $baseDir . '/core/routing.php',
    'Prompt_Script' => $baseDir . '/core/script.php',
    'Prompt_Signer' => $baseDir . '/core/signer.php',
    'Prompt_Site_Comments' => $baseDir . '/core/site-comments.php',
    'Prompt_Site_Icon' => $baseDir . '/core/site-icon.php',
    'Prompt_Stylify' => $baseDir . '/core/stylify.php',
    'Prompt_Subscribe_Matcher' => $baseDir . '/core/matchers/subscribe-matcher.php',
    'Prompt_Subscriber_Origin' => $baseDir . '/core/subscriber-origin.php',
    'Prompt_Subscribing' => $baseDir . '/core/subscribing.php',
    'Prompt_Subscription_Agreement_Email_Batch' => $baseDir . '/core/email-batches/subscription-agreement-email-batch.php',
    'Prompt_Subscription_Agreement_Mailer' => $baseDir . '/core/mailers/subscription-agreement-mailer.php',
    'Prompt_Subscription_Agreement_Wp_Mailer' => $baseDir . '/core/mailers/subscription-agreement-wp-mailer.php',
    'Prompt_Subscription_Mailing' => $baseDir . '/core/subscription-mailing.php',
    'Prompt_Template' => $baseDir . '/core/template.php',
    'Prompt_Text_Template' => $baseDir . '/core/text-template.php',
    'Prompt_Unsubscribe_Matcher' => $baseDir . '/core/matchers/unsubscribe-matcher.php',
    'Prompt_Unsubscribe_Template' => $baseDir . '/core/unsubscribe-template.php',
    'Prompt_User' => $baseDir . '/core/user.php',
    'Prompt_User_Handling' => $baseDir . '/core/user-handling.php',
    'Prompt_User_Mailing' => $baseDir . '/core/user-mailing.php',
    'Prompt_Web_Api_Handling' => $baseDir . '/core/web-api-handling.php',
    'Prompt_Wp_Mailer' => $baseDir . '/core/mailers/wp-mailer.php',
